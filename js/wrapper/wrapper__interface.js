...
var buttonCircleMiddle = document.querySelector(
  ".wrapper__button-circle_middle"
);
var buttonCircleRight = document.querySelector(".wrapper__button-circle_right");
var buttonCircleBottom = document.querySelector(
  ".wrapper__button-circle_bottom"
);
...
menuButton.addEventListener("mouseleave", function () {
  ...
  buttonCircleMiddle.classList.remove(
    "wrapper__button-circle_middle_transform"
  );
  buttonCircleRight.classList.remove("wrapper__button-circle_right_transform");
  buttonCircleBottom.classList.add("zero-opacity");
  buttonCircleBottom.classList.remove(
    "wrapper__button-circle_bottom_transform"
  );
});
